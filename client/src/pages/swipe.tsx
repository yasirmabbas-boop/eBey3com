...
function SwipeCard({ 
  ...
  return (
    <div className="relative h-full w-full bg-black">
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent p-4 pb-24">
      ...
      <Link href={`/product/${listing.id}`}>
        <Button 
          className="absolute bottom-6 left-4 right-20 bg-primary hover:bg-primary/90"
          size="lg"
        >
          {listing.saleType === "auction" 
