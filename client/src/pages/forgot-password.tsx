          ...
          <Card>
            <CardContent className="pt-8 pb-8 text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                {language === "ar" ? "سيقوم فريق الدعم بمراجعة طلبك والتواصل معك خلال 24 ساعة" : language === "ku" ? "تیمی پاڵپشتی داواکارییەکەت پێداچوونەوە دەکات و لە ماوەی ٢٤ کاتژمێردا پەیوەندیت پێوە دەکات" : "سيقوم فريق الدعم بمراجعة طلبك والتواصل معك خلال 24 ساعة"}
              </p>
              <Button 
