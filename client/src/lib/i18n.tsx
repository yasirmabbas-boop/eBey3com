...
export const translations: Translations = {
  ...
  applyFilters: { ar: "تطبيق الفلاتر", ku: "فلتەرەکان جێبەجێ بکە" },
  clearFilters: { ar: "مسح الفلاتر", ku: "سڕینەوەی فلتەرەکان" },
  clearAllFilters: { ar: "مسح جميع الفلاتر", ku: "سڕینەوەی هەموو فلتەرەکان" },
  clearAll: { ar: "مسح الكل", ku: "سڕینەوەی هەموو" },
  quickFilter: { ar: "تصفية سريعة:", ku: "فلتەری خێرا:" },
  allProducts: { ar: "جميع المنتجات", ku: "هەموو بەرهەمەکان" },
  allCategories: { ar: "جميع الفئات", ku: "هەموو پۆلەکان" },
  productAvailable: { ar: "منتج متاح", ku: "بەرهەم بەردەستە" },
  moreFilters: { ar: "المزيد", ku: "زیاتر" },
  browseMode: { ar: "وضع التصفح", ku: "دۆخی گەڕان" },
  showSold: { ar: "عرض المباع", ku: "فرۆشراوەکان پیشان بدە" },
  from: { ar: "من", ku: "لە" },
  to: { ar: "إلى", ku: "بۆ" },
  inIraqiDinar: { ar: "بالدينار العراقي", ku: "بە دیناری عێراقی" },
  product: { ar: "منتج", ku: "بەرهەم" },
  anotherProduct: { ar: "منتج آخر", ku: "بەرهەمی تر" },
  showMore: { ar: "عرض المزيد", ku: "زیاتر پیشان بدە" },
  tryChangingFilters: { ar: "جرب تغيير الفلاتر أو البحث بكلمات أخرى", ku: "هەوڵبدە فلتەرەکان یان وشەکان بگۆڕیت" },
  store: { ar: "متجر", ku: "دوکان" },
  salesCount: { ar: "عملية بيع", ku: "فرۆشتن" },
  positiveRating: { ar: "تقييم إيجابي", ku: "هەڵسەنگاندنی باش" },
  mostRelevant: { ar: "الأكثر صلة", ku: "پەیوەندیدارترین" },
  newest: { ar: "الأحدث", ku: "نوێترین" },
  priceLowToHigh: { ar: "السعر: من الأقل للأعلى", ku: "نرخ: لە کەمەوە بۆ زۆر" },
  priceHighToLow: { ar: "السعر: من الأعلى للأقل", ku: "نرخ: لە زۆرەوە بۆ کەم" },
  endingSoon: { ar: "ينتهي قريباً", ku: "بە زووی تەواو دەبێت" },
  mostBids: { ar: "الأكثر مزايدة", ku: "زۆرترین مزایدە" },
  saleTypeLabel: { ar: "نوع البيع", ku: "جۆری فرۆشتن" },
  cityLabel: { ar: "المدينة", ku: "شار" },
  conditionLabel: { ar: "الحالة", ku: "دۆخ" },
  categoriesLabel: { ar: "الفئات", ku: "پۆلەکان" },
  priceLabel: { ar: "السعر:", ku: "نرخ:" },
  vintageAntique: { ar: "فينتاج / أنتيك", ku: "ڤینتەیج / کۆن" },
  almostNew: { ar: "شبه جديد", ku: "وەک نوێ" },
  ...
  offers: { ar: "العروض", ku: "پێشنیارەکان" },
  sales: { ar: "المبيعات", ku: "فرۆشتنەکان" },
};
