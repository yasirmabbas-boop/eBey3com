...
export const translations: Translations = {
  ...
  anbar: { ar: "الأنبار", ku: "ئەنبار", en: "Al-Anbar" },
  babel: { ar: "بابل", ku: "بابل", en: "Babylon" },
  diyala: { ar: "ديالى", ku: "دیالە", en: "Diyala" },
  dhiQar: { ar: "ذي قار", ku: "زیقار", en: "Dhi Qar" },
  qadisiyah: { ar: "القادسية", ku: "قادسیە", en: "Al-Qadisiyyah" },
  muthanna: { ar: "المثنى", ku: "موسەننا", en: "Al-Muthanna" },
  maysan: { ar: "ميسان", ku: "مەیسان", en: "Maysan" },
  salahAlDin: { ar: "صلاح الدين", ku: "سەلاحەددین", en: "Salah ad-Din" },
